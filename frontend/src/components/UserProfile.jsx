...
export default function UserProfile() {
  ...
  return (
    <div className="relative">
      ...
      <button className="bg-blue-350 text-white rounded-full w-11 h-11 flex items-center justify-center hover:bg-blue-700 transition duration-200" onClick={handleProfileClick}>
        <img className={`w-10 h-10 rounded-full `} src={userData.pic} alt="Profile" />
      </button>

      {/* open popup */}
      {isPopupOpen && (
        <div ref={popupRef} className="text-center text-white absolute right-0 min-w-[200px] w-[25vw] bg-gradient-to-r from-purple-600 via-fuchsia-500 to-green-400 rounded-md shadow-xl">
          <div className="text-center p-6 border-b relative">
            <img className={`cursor-pointer h-full w-full rounded-full`} src={userData.pic} alt="Profile" />
          </div>
